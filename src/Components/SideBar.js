            ...
            <div class="container-fluid">
              <Link to="/">
                <h1 class="navbar-brand">
                    <Link to='/' style={{color:"black", textDecoration:"none"}}><button><img style={{height:"50px",width:"80px",margin:"5px"}} alt='' src={Phool}></img></button></Link>
                </h1>
              </Link>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  <ul class="navbar-nav me-auto mb-2 mb-lg-0" style={{textDecoration:"none"}}>
                      ...
                      <div className='Cart'>
                        <Link to='/Cart'><Button variant="light" className='btn-md' style={{padding:"5px",textDecoration:"none", color:"black"}}>Cart</Button></Link>
                      </div>
                      <div>
